		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori_cicd_module_title",
									"targetURL": "#fioridevefioricicdmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioridevefioricicdmodule-display": {
								"semanticObject": "fioridevefioricicdmodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorideve.fioricicdmodule",
									"url": sap.ui.require.toUrl("fiorideve/fioricicdmodule")
								}
							}
						}
					}
